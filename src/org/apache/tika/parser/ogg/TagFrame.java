...
public class TagFrame {
     ...
     */
    public static TagFrame createFrameIfPresent(InputStream inp)
            throws IOException {
        int h1 = inp.read();
        int h2 = inp.read();
        int h3 = inp.read();
        ...
        if (h1 == (int)'I' && h2 == (int)'D' && h3 == (int)'3') {
            ...
            return new TagFrame(majorVersion, minorVersion, inp);
        }
    ...
    private TagFrame(int majorVersion, int minorVersion, InputStream inp)
            throws IOException {
