...
import org.apache.tika.parser.ogg.TagFrame.RawTag;
import org.apache.tika.parser.ogg.TagFrame.RawTagIterator;
...
public class OggTagHandler {
    ...
    public OggTagHandler(TagFrame frame)
    ...
    private String getTagString(byte[] data, int offset, int length) {
        return TagFrame.getTagString(data, offset, length);
    }
    ...
    private class RawV22TagIterator extends RawTagIterator {
        private RawV22TagIterator(TagFrame frame) {
            frame.super(3, 3, 1, 0);
        }
    }
